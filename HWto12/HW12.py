...
def create_mini_batches(X, Y, mini_batch_size):
    ...
    num_complete_minibatches = m // mini_batch_size  # Number of mini batches of size mini_batch_size in your partitioning
...
def gradient_descent(X, Y, alpha, iterations, mini_batch_size, dropout_rate=0.5, lambd=0.1):
...
def forward_prop(W1, b1, W2, b2, X, dropout_rate=0.5):
    ...
    A1 = A1 / dropout_rate  # Scale the values of neurons that haven't been dropped out
    ...
    return Z1, A1, Z2, A2, D1  # Return dropout mask D1
...
def backward_prop(Z1, A1, Z2, A2, W1, W2, X, Y, D1, dropout_rate=0.5):
    ...
    # Apply Dropout
    dZ1 = np.multiply(dZ1, D1)
    dZ1 = dZ1 / dropout_rate
...
def update_params(W1, b1, W2, b2, dW1, db1, dW2, db2, alpha , lambd=0.1):
    ...
    # L2 Regularization
    W1 = W1 * (1 - alpha * lambd / m) - alpha * dW1
    W2 = W2 * (1 - alpha * lambd / m) - alpha * dW2
    b1 = b1 - alpha * db1    
    b2 = b2 - alpha * db2    
    return W1, b1, W2, b2
...
def gradient_descent(X, Y, alpha, iterations, dropout_rate=0.5, lambd=0.1 ):
    ...
    for i in range(iterations):
        ...
        Z1, A1, Z2, A2, D1 = forward_prop(W1, b1, W2, b2, X, dropout_rate)
        dW1, db1, dW2, db2 = backward_prop(Z1, A1, Z2, A2, W1, W2, X, Y, D1, dropout_rate)
